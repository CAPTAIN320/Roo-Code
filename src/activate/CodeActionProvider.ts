...
export const TITLES: Record<CodeActionName, string> = {
	EXPLAIN: "Explain with Code Captain",
	FIX: "Fix with Code Captain",
	IMPROVE: "Improve with Code Captain",
	ADD_TO_CONTEXT: "Add to Code Captain",
	NEW_TASK: "New Code Captain Task",
} as const
